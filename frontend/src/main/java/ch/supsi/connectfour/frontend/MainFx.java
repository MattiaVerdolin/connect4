...
public class MainFx extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        try {
            ...
            FXMLLoader menuBarLoader = new FXMLLoader(fxmlUrl, translationController.getTranslationBundle());
            menuBar = menuBarLoader.load();
            this.menuBarDispatcher = menuBarLoader.getController();
            menuBarDispatcher.setPrimaryStage(primaryStage);
        ...
        gameController.uploadSignsColorsIntoBoardView();

        //PERSISTENCE CONTROLLER
        persistenceController.setBoardView(boardView);
        persistenceController.setInfoBarView(infoBarView);

        //messaggio di benvenuto
        gameController.WelcomeText();
